...
public class AdoptionRecordHttpClient {
    ...
    private final static String CREATE_URL = "http://localhost:8080/adoptionRecord/create";
    private final static String READ_URL = "http://localhost:8080/adoptionRecord/read";
    private final static String UPDATE_URL = "http://localhost:8080/adoptionRecord/update";
    private final static String DELETE_URL = "http://localhost:8080/adoptionRecord/delete";
    private final static String GET_ALL_URL = "http://localhost:8080/adoptionRecord/getAll";
